...
<head>
    ...
    <form action="#" class="hm-searchbox" style="display: inline-block;">
        <input id="searchInput" type="text" placeholder="Enter your search key ...">
        <button class="li-btn" type="button" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample"><i class="fa fa-filter"></i></button>
        
        <div id="suggestionsContainer" style="background-color: transparent; position: absolute; top: 100%; z-index: 9999;"></div>
    </form>
</div>
            ...
            <div class="footer">
                ...
                <div hidden class="footer-static-middle">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center">
                                    <a href="#">
                                        <img hidden src="images/payment/1.png" alt="">
                                    </a>
                                </div>
                                <!-- Footer Payment Area End Here -->
                                <!-- Begin Copyright Area -->
                                <div hidden class="copyright text-center pt-25">
