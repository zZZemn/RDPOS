...
<?php
$query = "SELECT DISTINCT pr.precord_date, spl.spl_name, s.s_id, p.prod_code, p.prod_name, p.prod_description, p.prod_image, s.s_expiration, c.category_name, s.s_amount
FROM stocks s
...
LEFT JOIN purchased_record as pr ON pr.precord_reference = s.s_precord_reference
