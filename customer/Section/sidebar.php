    ...
    <div style="background-color:#600000;" class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="<?php if (strpos($currentURL, 'my-orders.php') !== false) echo 'active'; ?>">
                    <a href="my-orders.php"><img src="assets/img/icons/purchase1.svg" alt="img"><span> Orders</span> </a>
                </li>
