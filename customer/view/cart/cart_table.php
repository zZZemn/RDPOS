...
while ($product_row = mysqli_fetch_assoc($view_product_query)) {
    ...
    echo '<div class="product_wrap product_wrapFind" >';
    if ($prod_stocks <= 0) {
    ...
    echo '<label for="myCheckbox"></label>';
    ...
    echo '<div hidden class="product_wrap product_wrapFind">';
    echo '<input id="db_cart_id" type="text" name="cart_id[]" class="cart-id" value="' . $db_cart_id . '">';
    echo '</div>';

    echo '<div class="product_wrap" style="width:50%;">';
    echo '<div class="product_data">';
    echo '<div class="description">';
    echo '<div class="main_header">' . ucwords($db_prod_name) . ' ';
    ...
    if ($getDiscountValue > 0) {
        ...
        echo '  <div class="row" >';
        echo '    <div class="col-md-12">'; // Center the content within the column
