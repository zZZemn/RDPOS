...
<div class="position-fixed d-flex justify-content-center align-items-center footer" >
    <div id="totalBillCOntainer" class="checkout-container" style="background-color: #600000;  ">
       ...
       <!--- <button id="checkDeliveryOrPick" type="button" class="btn btn-primary" style="width:100%;" data-bs-toggle="modal" data-bs-target="#PickUpOrDelivery">CheckOut
        <i class="fas fa-check fs-4"></i>
                    <i class="fas fa-shopping-cart"></i>
    </button>--->
    <button type="submit" type="checkoutButton" name="btnCheckOut" class="btn btn-primary" style="width:100%;" data-bs-toggle="modal" >CheckOut
        <i class="fas fa-check fs-4"></i>
                    <i class="fas fa-shopping-cart"></i>
    </button>
