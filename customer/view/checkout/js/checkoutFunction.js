...
$('#ConfirmSelectAddress').click(function(e) {
    ...
    var regionId = $('#region_add').val();
    var provinceId = $('#province_add').val();
    var cityId = $('#city_add').val();
    var barangayId = $('#brgy_add').val();
    var streetDescription = $('#AddstreetDescription').val();
    ...
    if (fullname === "") {
     ...
     if (phoneNumber === "") {
      ...
      // Validate fullname
      if (complete_address_add === "") {
        alertify.error("Address is required");
        return; // Stop execution if fullname is empty
    }

    if (streetDescription === "") {
        alertify.error("Street description is required");
        return; // Stop execution if fullname is empty
    }
