                ...
                <div class="col mb-5">
                    <div class="card h-100 custom-card" style="color: black; background-color: white; border-color: gray;" >
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                <button class="w-100 btn togler" data-bs-toggle="modal"
                                    ...
                                    <button class="w-100 btn toglerBuyNow mt-3" data-bs-toggle="modal" data-bs-target="#modalBuynow" data-id="<?= $prod_id ?>" data-db_prod_name="<?= $prod_name ?>" data-db_prod_currprice="<?= $db_prod_currprice ?>" data-ssid="<?= $db_s_id ?>"<?php if ($db_stocks <= 0) {
                echo "disabled";
            } ?>
