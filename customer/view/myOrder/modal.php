		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-danger cancelBtn">Yes</button>
...
<div class="modal fade" id="modTrash" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<input hidden type="text" id="orders_id_remove" class="orders_id"  name="order_id">
					<input hidden type="text" id="value2" class="order_transaction_code"  name="value2">
					<input hidden type="text" id="orders_status_rem" class="orders_status" name="orders_status_rem" required>
