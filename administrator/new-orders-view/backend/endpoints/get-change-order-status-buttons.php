...
?>
            <button class="btn btn-success btnUpgradeStatus" data-id="<?= $orderId ?>"><i class="bi bi-check2"></i> Accept</button>
            <button class="btn btn-danger btnRejectOrder" data-id="<?= $orderId ?>"><i class="bi bi-x-lg"></i> Reject</button>
        <?php
        } elseif ($orderStatus == 'Accepted') {
        ?>
            <button class="btn btn-success btnUpgradeStatus" data-id="<?= $orderId ?>"><i class="bi bi-box-fill"></i> Order Packed</button>
