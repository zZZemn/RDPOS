...
$expirationDate = isset($_POST["expirationDate"]) ? $_POST["expirationDate"] : NULL;
    ...
    $insertStocksQuery = "INSERT INTO stocks(s_stockin_date, s_invoice, s_expiration, s_prod_id, s_amount, s_spl_id, s_status,s_supplierPrice) 
                          VALUES ('$current_date','$invoice_no', '$expirationDate', '$db_prod_id', '$qty', '$db_spl_id', '1', '$supplierPrice')";
