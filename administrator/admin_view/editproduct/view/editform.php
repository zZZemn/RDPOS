...
?>
<option <?php if($db_prod_category_id==$category_id){ echo "selected";} ?> value='<?= $category_id ?>'><?= $category_name?></option>
<?php }?>
</select>
...
<select class="select" name="pVouch" id="pVouch">
<option <?php if($db_prod_voucher_id==0){ echo "selected";} ?> value='N/A'>N/A</option>
<?php 
date_default_timezone_set('Asia/Manila');
$currentDateTime = date('Y-m-d H:i:s');
$view_query = mysqli_query($connections,"SELECT * from voucher where voucher_status='1' AND voucher_expiration >= '$currentDateTime' AND voucher_maximumLimit >= 1  "); 
...
?>
<option <?php if($db_prod_voucher_id==$voucher_id){ echo "selected";} ?> value='<?= $voucher_id ?>'><?= $voucher_name?></option>
<?php } ?>
</select>
...
<div class="col-lg-4 col-sm-6 col-12 mt-4" >
  <div class="row">
    <div class="form-group col-4">
      <label>Kg</label>
      <input type="number" class="form-control" value="<?=$db_prod_kg?>" id="kg" min="0" max="1000">
...
<input type="checkbox" id="vatableTogler" class="check" <?php if($db_prod_vatable=="1"){ echo "checked";} ?>>
...
<div class="status-toggle d-flex justify-content-between align-items-center">
<input type="checkbox" id="SellOnlineTogler" class="check" <?php if($db_prod_sell_onlline=="1"){ echo "checked";} ?>>
