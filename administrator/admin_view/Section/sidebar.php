...
<li >
<a href="#"><img src="assets/img/increasing.png" alt="img"><span class="text-white"> Sales</span> </a>
</li>
...
<li><a href="#" <?php if (strpos($currentURL, '#') !== false) echo 'class="active"'; ?>>Discounts</a></li>
