...
<body>
    ...
    <nav>
                ...
                <ul class="standard-menu" onclick="window.location.href = '<?php if($db_acc_type=="administrator"){ echo '../../administrator/admin_view/index.php';}else{ echo '#';} ?>';">
                    <li><img src="../assets/images/logos.png" alt="LOGO"></li>
                    <li><h4 class="fw-bolder">RDPOS</h4></li>
        ...
        <ul class="right-menu">
            ...
            <li><a class="btn a" href="../pages/inventory">Inventory</a></li>
            <li><a class="btn a" href="../pages/listpurchase">Manage stocks</a></li>
            <li class=" dropdown">
